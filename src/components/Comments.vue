  ...
  <div id="respond-post-288" class="comment-container">
    <div id="comments" class="clearfix">
      ...
      <form id="comment-form" class="comment-form" role="form" @submit.prevent="postComm">
        ...
        <input type="text" id="name"  maxlength="12" v-model="name" class="form-control input-control clearfix" placeholder="名称 (*)"  required>
        <input type="email" v-model="email" class="form-control input-control clearfix" placeholder="邮箱 (*)"  required>
        <input type="url" v-model="url" class="form-control input-control clearfix" placeholder="个人站点地址(选填) (http://)" >
        <textarea v-model="content" class="form-control" placeholder="你的评论很Cool" required ></textarea>
        <button  class="submit" type="submit" >提交</button>
      </form>

      <ol class="comment-list">
        <template v-for="(comm, index) in commlist" :key="index">
          <li id="li-comment"  v-if="comm.pid === 0" class="comment-body comment-parent comment-odd">
            <div id="comment" >
              <div class="comment-view" onclick="">
                ...
                <div class="comment-meta">
                  <time class="comment-time">{{dateFormat(comm.time)}}</time>
            ...
            <div class="comment-children">
              <ol class="comment-list">
                <template v-for="(child, index) in commlist" :key="index">
                  <li  v-if="child.pid === comm.id" class="comment-body comment-child comment-level-odd comment-even" id="li-comment-2608">
                    <div id="comment-2608">
                      <div class="comment-view" onclick="">
                        <div class="comment-header">
                        ...
                        <div class="comment-meta">
                          <time class="comment-time">{{dateFormat(child.time)}}</time>
                          <span class="comment-reply">
...
<script>
    ...
    import {hex_md5} from '../../static/lib/md5';
